# Generated by Django 4.2.27 on 2026-01-30 08:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(db_index=True, max_length=64, unique=True, verbose_name='认证令牌')),
                ('labels', models.JSONField(blank=True, default=list, verbose_name='能力标签')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('node_id', models.CharField(max_length=64, verbose_name='节点 ID')),
                ('pipeline_id', models.CharField(max_length=64, verbose_name='Pipeline ID')),
                ...
                ('parameters', models.JSONField(blank=True, default=dict, verbose_name='输入参数')),
